<template>
    <div class="page">
        <div class="mainHeader">
            ...
            <button @click="createTeacher">Update Teacher</button>
        </div>
        <div class="detailsContainer">
            <div class="detailsInfo">
                <div class="infoBox">
                    ...
                    <div class="infoItem">
                        <p>Honorific</p>
                        <input type="text" :class="honorificStatus === false ? 'formInputerror' : ''" v-model="honorific">
                    </div>
                    <div class="infoItem">
                        <p>Name</p>
...
export default {
    ...
    methods: {
        ...
        async createTeacher() {
            const response = await apiClient.post('/teachers/update_teacher', {  
                teacher_id: this.teacher_details.id,              
    ...
    mounted(){
        this.teacher_details = this.appStore.findTeacher(this.data.id)
        this.honorific = this.teacher_details.honorific
        this.name = this.teacher_details.name
        this.email = this.teacher_details.email
        this.phone = this.teacher_details.phone
    }
}
</script>
<style scoped>
