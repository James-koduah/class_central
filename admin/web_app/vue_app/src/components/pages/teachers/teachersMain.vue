<template>
    <div>
        <div class="blank">
            ...
            <input type="text" placeholder="Search Teachers Database">
        </div>
        <div class="database">
            <div class="actions">
                <div class="action">
...
export default {
    ...
    data() {
        return {
            headers: ['Name', 'Email', 'Phone Number', 'Position'],
            rows: [
                ['Mr. Alex Ushe', 'alexushe@gmail.com', '123456789', 'Head Master'],
                ['Mr. James Koduah', 'jameskoduah@gmail.com', '456789123', 'Sports Teacher'],
                ['Miss Diana Yusfef', 'dianayusfef@gmail.com', '987654321', 'Libarian'],
            ],
